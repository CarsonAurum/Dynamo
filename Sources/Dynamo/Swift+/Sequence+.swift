...
/// A sequence created to store the first section of a larger sequence until the first element instance that
...
extension Sequence {
    public func join<A: Sequence>(_ other: A) -> Join2Sequence<Self, A> {
        .init((self, other))
    }
