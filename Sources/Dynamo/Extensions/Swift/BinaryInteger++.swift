...
extension BinaryInteger {
    ...
    public var kFormatted: String {
        if self == 0 {
            return "0k"
        } else if (self >= 0 && self < 1_000) || (self <= 0 && self > -1_000) {
            return "0k"
        } else if (self >= 1_000 && self < 1_000_000) || (self <= -1_000 && self > -1_000_000) {
            return "\(self / 1_000)k"
        }
    ...
    public var timeString: String {
        ...
        if self < 3_600 { return "\(self / 60) min" }
